...
from distributed_utils import MetricLogger
from distributed_utils import SmoothedValue
from distributed_utils import warmup_lr_scheduler
from distributed_utils import reduce_dict
...
from mydataset import TARGET_FIELD_TASK2_LABEL
...
def evaluate(epoch, model, data_loader, device, data_set=None):
    ...
    for images, targets in metric_logger.log_every(data_loader, 100, header):
        ...
        save_anchor_pic(image=images, path="./output/evaluate_pred.jpg", bboxes=bboxes,
                        bboxes_label=labels, height=300, width=300,
